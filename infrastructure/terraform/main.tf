# DevOps Portfolio Infrastructure as Code
# Complete infrastructure setup using Terraform, Docker, and Kubernetes
...
# ECR Repository for portfolio images
